        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="space-y-4">
              <div class="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select v-model="orderForm.city" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none">
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Индекс</label>
                  <input v-model="orderForm.zip" type="text" placeholder="010000"
                         class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input v-model="orderForm.street" type="text" required placeholder="Название улицы"
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none"
                />
              </div>
              ...
              <div class="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input v-model="orderForm.house" type="text" required placeholder="№"
                         class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none"
                  />
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Квартира</label>
                  <input v-model="orderForm.apartment" type="text" placeholder="№"
                         class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none"
                  />
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Подъезд</label>
                  <input v-model="orderForm.entrance" type="text" placeholder="№"
                         class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea v-model="orderForm.comment" rows="3" placeholder="Укажите удобное время доставки"
          ...
          <div class="bg-white rounded-xl p-6 shadow-md">
            ...
            <div class="flex gap-3">
              <input v-model="promoCode" type="text" placeholder="Введите промокод"
...
export default {
  ...
  methods: {
    fullImageUrl(path) {
      return path.startsWith("http") ? path : `${this.apiBase}/storage/${path}`;
    },
    async fetchCart() {
      try {
        ...
        this.cartItems = res.data.map(item => ({
          ...item,
          image: item.image ? this.fullImageUrl(item.image) : null
        }));
      } catch (e) {
